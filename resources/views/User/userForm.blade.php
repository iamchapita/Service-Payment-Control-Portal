<div class="input-group mb-3">
    ...
    <input type="text" class="form-control" required autocomplete="off" name="texName" id="texName"
        placeholder="Ingrese un nombre del Usuario"
        @if (isset($values)) @foreach ($values as $value) value={{ $value->texName }} @endforeach @endif>
</div>
...
<div class="input-group mb-3">
    ...
    <select class="form-select" name="boolStatus" id="boolStatus" required autocomplete="off">
        ...
        <option value="0"
            @if (isset($values)) @foreach ($values as $value) @if ($value->boolStatus == 0)
            selected @endif
            @endforeach
            @endif
            >
        ...
        <option value="1"
            @if (isset($values)) @foreach ($values as $value) @if ($value->boolStatus == 1)
            selected @endif
            @endforeach
            @endif
            >
...
<div class="input-group mb-3">
    ...
    <select class="form-select" name="boolAdminStatus" id="boolAdminStatus" required autocomplete="off">
        ...
        <option value="0"
            @if (isset($values)) @foreach ($values as $value) @if ($value->boolAdminStatus == 0)
            selected @endif
            @endforeach
            @endif
            >
        ...
        <option value="1"
            @if (isset($values)) @foreach ($values as $value) @if ($value->boolAdminStatus == 1)
            selected @endif
            @endforeach
            @endif
            >
