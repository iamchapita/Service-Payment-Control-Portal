...
<div class="input-group mb-3">
    ...
    <input
        type="date"
        class="date form-control"
        name="depositDateInput"
        @if(isset($values))
            @foreach($values as $value)
                value={{ $value->datDepositedDate }}
            @endforeach
        @endif
        id="depositDateInput" autocomplete="off"
    >
</div>
